...
{
    partial class Member:IDrawable
    {
        ...
        public Member(int memID, string description, Button picture)
        {
        ...
        public void Draw(float x, float y, Graphics gr, Pen pen, Brush bg_brush, Brush text_brush, Font font)
        {
            ...
            if (Selected)
            {
                gr.FillRectangle(Brushes.Turquoise, rect);
            ...
            gr.DrawString(Picture.Text, new Font("Times New Roman", 8,FontStyle.Bold), Brushes.Black, rectf,sf);

        }

        // Find a rectangle to draw the image centered in the
        // rectangle as large as possible without stretching.
        private RectangleF PositionImage(Button picture, RectangleF rect)
        {
